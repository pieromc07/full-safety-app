...
@section('content')
    ...
    @endif
    <x-form class="card" id="form-create" action="{{ route('employees.store') }}" method="POST" role="form">
        <div class="card-body">
            <div class="row">
                @include('employees.fields', ['readonly' => false, 'view' => null])
            </div>
        </div>
