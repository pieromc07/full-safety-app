        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    {{-- <h3 class="card-title">{{$active->topic}}</h3> --}}
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-3">
                            <x-input id="checkpoint" name="checkpoint" label="Punto de Control" class="form-control"
                                ...
                                value="{{ $active->checkpoint->name }}" readonly />
                        </div>
                        <div class="col-12 col-lg-3">
                            <x-input id="enterprise" name="enterprise" label="Empresa Transportista" class="form-control"
                                ...
                                icon="bi-building" value="{{ $active->enterpriseTransport->name }}" readonly />
                        </div>
                        <div class="col-3 col-lg-3">
                            <x-input id="participants" name="participants" label="participants" class="form-control"
                                ...
                                value="{{ $active->participants }}" readonly />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6">
                            <div class="row">
                                ...
                                <img src="{{ asset('storage/' . $active->photo_one) }}" class="img-fluid" id="photo_one">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                ...
                                <img src="{{ asset('storage/' . $active->photo_two) }}" class="img-fluid" id="photo_two">
                            </div>
                        </div>
                    </div>
                </div>
