    ...
    <div class="d-flex align-items-center flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">
            ...
            <a href="{{ route('home') }}" class="app-sidebar-logo">
                <img src="{{ asset('assets/media/logos/logo.png') }}" alt="{{ config('app.name') }}"
                    class="h-30px" />
                <span class="text-dark fs-5 fw-bolder ms-2 theme-light-show">{{ config('app.name') }}</span>
                <span class="text-white fs-5 fw-bolder ms-2 theme-dark-show">{{ config('app.name') }}</span>
            </a>
            <!--end::Logo-->
                ...
                <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px d-none"
                    ...
                    <form data-kt-search-element="form" class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0"
                        ...
                        <input type="text" class="search-input form-control form-control border-0 h-lg-40px ps-13"
                            name="search" value="" placeholder="Buscar..." data-kt-search-element="input" />
                        <!--end::Input-->
                        <!--begin::Spinner-->
            ...
            <div class="app-navbar-item ms-3 ms-lg-4 me-lg-2" id="kt_header_user_menu_toggle">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">
                                    ...
                                    @if (Auth::user()->hasRole('master'))
                                        <span class="badge badge-light-danger fw-bold fs-8 px-2 py-1 ms-2">Master</span>
                                    @elseif (Auth::user()->hasRole('admin'))
                                        <span class="badge badge-light-primary fw-bold fs-8 px-2 py-1 ms-2">Admin</span>
                                    @elseif (Auth::user()->hasRole('inspector'))
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Inspector</span>
                                    @elseif (Auth::user()->hasRole('empresa'))
                                        <span class="badge badge-light-info fw-bold fs-8 px-2 py-1 ms-2">Empresa</span>
                                    @endif
                                </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{ route('users') }}" class="menu-link px-5">
                    ...
                    <!--end::Mi Perfil-->
                    <!--begin::Seguridad (solo admin/master)-->
                    @if (Auth::user()->hasRole('master') || Auth::user()->hasRole('admin'))
                    <div class="menu-item px-5">
                        <a href="{{ route('roles') }}" class="menu-link px-5">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <a href="#" class="menu-link px-5">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-night-day theme-light-show fs-4">
                                    <span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span><span class="path7"></span><span class="path8"></span><span class="path9"></span><span class="path10"></span>
                                </i>
                                <i class="ki-duotone ki-moon theme-dark-show fs-4">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                            ...
                            <div class="menu-item px-3 my-0">
                                <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
                                    ...
                                    <span class="menu-title">Automático</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <form action="{{ route('logout') }}" method="POST" id="form-logout">
                            @csrf
                            <a href="#" class="menu-link px-5" onclick="event.preventDefault(); document.getElementById('form-logout').submit();">
                                <span class="menu-icon">
