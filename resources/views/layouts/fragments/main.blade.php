...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                        ...
                        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 lh-0">
                            @yield('page', 'Panel de Control')
                        </h1>
                    </div>
                </div>
            </div>
    ...
    <div id="kt_app_footer"
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <span class="text-gray-800 fw-semibold">{{ config('app.name') }}</span>
            <span class="text-muted fw-semibold ms-1">- Sistema de Inspección y Seguridad Ocupacional</span>
        </div>
    </div>
    <!--end::Footer-->
</div>
